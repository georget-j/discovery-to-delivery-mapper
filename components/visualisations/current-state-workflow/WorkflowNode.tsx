...
// Card hover affordance — lift + grab cursor so the canvas feels manipulable.
const HOVER_CARD =
...
> = {
  ...
  missing_info: {
    container: "border-orange-300 bg-orange-50/80 border-dashed",
...
function WorkflowNodeImpl({ id, data, selected }: NodeProps) {
  ...
  return (
    <div className="relative">
      ...
      <div
        className={cn(
          "rounded-md border-2 px-3 py-2 min-w-[160px] max-w-[200px] shadow-sm",
          HOVER_CARD,
          style.container,
