  ...
  return (
    <aside className="w-60 shrink-0 border-r border-border bg-muted/20 flex flex-col">
      ...
      <nav className="flex-1 overflow-y-auto py-2">
        {PHASES.map((phase) => (
          <PhaseGroup key={phase.id} phase={phase} base={base} pathname={pathname} />
        ))}
      </nav>
        ...
        <div className="flex items-center gap-2">
          <span className={cn(
            ...
            complete
              ...
              : cn(phase.color.bgSubtle, phase.color.text, "border", phase.color.border)
          )}>
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive
                  ? cn("bg-background font-medium shadow-sm border", phase.color.border, phase.color.text)
